...
const categories = [
  { id: 1, name: 'accessories', color: '#01A4A4' },
  { id: 2, name: 'boxing', color: '#9161e8' },
  { id: 3, name: 'cardio', color: '#7cc245' },
  { id: 4, name: 'pilates', color: '#91c7f9' },
  { id: 5, name: 'free weights', color: '#f9fa5e' },
  { id: 6, name: 'smart fitness', color: '#ee2a82' },
  { id: 7, name: 'yoga', color: '#f46854' },
  { id: 8, name: 'resistance', color: '#00A1CB' }
];
